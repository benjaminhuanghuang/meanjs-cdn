  ...
  function routeConfig($stateProvider) {
    $stateProvider
      ...
      .state('libraries.list', {
        url: '',
        templateUrl: 'modules/libraries/client/views/list-libraries.client.view.html',
      ...
      .state('libraries.create', {
        url: '/create',
        templateUrl: 'modules/libraries/client/views/form-library.client.view.html',
      ...
      .state('libraries.view', {
        url: '/:libraryId',
        templateUrl: 'modules/libraries/client/views/view-library.client.view.html',
        controller: 'LibrariesController',
        controllerAs: 'vm',
        resolve: {
          libraryResolve: getLibrary
